...
function PublicHeader() {
  ...
  return (
    <header className="print-hide fixed top-0 left-0 right-0 navbar bg-base-100 min-h-0 shrink-0 justify-between z-20 px-0 sm:px-2 border-b border-base-300">
      ...
      <div className="navbar-end grow mr-4">
        <Link to="/dapp" className="btn btn-primary btn-sm">
          Open App
        </Link>
      </div>
